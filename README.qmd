...
slurm-script-generator is a pure python tool for generating SLURM script in the command line, or via a [Python API](https://max-models.github.io/slurm-script-generator/tutorials/00_basics.html), or via a [web application](https://max-models.github.io/slurm-script-generator/webapp.html).
